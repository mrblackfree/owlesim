...
class BatchUpdateInAppProductsJob implements ShouldQueue
{
    ...
    public function __construct(string $packageName, array $items)
    {
        ...
        try {
            ...
            foreach ($this->items as $item) {
                ...
                foreach ($currencies as $currency) {
                    $prices[$currency] = (new \Google_Service_AndroidPublisher_Price())
                ...
                $iap = new \Google_Service_AndroidPublisher_InAppProduct([
                    ...
                    'defaultPrice' => $prices['INR'], // must always be set
                    'prices' => $prices,
                ...
                $entry->setAutoConvertMissingPrices(false); // we already provide all
            ...
            // Execute
            $response = $service->inappproducts->batchUpdate($this->packageName, $batchReq);
