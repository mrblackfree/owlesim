...
const EsimToRule: React.FC<EsimToRuleProps> = ({
    ...
    const defaultCards: FeatureCard[] = [
        ...
        },
        {
            ...
            subtitle: 'eSimtel exclusive, keeps you connected 24/7',
        ...
        },
        {
            ...
            subtitle: 'Even on unlimited packs, only with eSimtel',
    ...
    return (
        <div className='min-h-screen bg-white p-4 md:p-8'>
            ...
            <div className='mb-12 text-center'>
                <h1 className='mb-4 text-4xl font-bold text-indigo-700 md:text-6xl'>1 eSIM to rule</h1>
