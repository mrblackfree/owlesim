        ...
        <footer className='border-t border-gray-200 bg-white'>
            <div className='container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8'>
                ...
                <div className='mb-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4'>
                    ...
                    {/* eSIM */}
                    <div>
                        <h3 className='mb-4 text-lg font-semibold text-gray-900'>{t('home.footer.esim')}</h3>
                        <ul className='space-y-3'>
                            <li>
                                <Link href='/what-is-esim' className='text-gray-600 hover:text-gray-900'>
                                    {t('home.footer.whatIsEsim')}
                                </Link>
                            </li>
                            <li>
                                <Link href='/all-destinations' className='text-gray-600 hover:text-gray-900'>
                            ...
                            <li>
                                <Link href='/all-packages' className='text-gray-600 hover:text-gray-900'>
                                    {t('home.footer.allPackages')}
                                </Link>
                            </li>
                            <li>
                                <Link href='/country-plan' className='text-gray-600 hover:text-gray-900'>
                                    {t('home.footer.allCountryPlan')}
                                </Link>
                            </li>
                            <li>
                                <Link href='/region-plan' className='text-gray-600 hover:text-gray-900'>
                    ...
                    {/* Follow Us */}
                    <div>
                        <h3 className='mb-4 text-lg font-semibold text-gray-900'>{t('home.footer.followUs')}</h3>
                        <ul className='space-y-3'>
                            <li>
                                <Link
