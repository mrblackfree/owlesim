...
const WhatIsEsimPage = () => {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100'>
            {/* Hero Section */}
            <section className='px-4 pt-[200px] pb-16'>
                <div className='mx-auto max-w-7xl'>
                    <div className='grid items-center gap-12 lg:grid-cols-2'>
                        {/* Left Content */}
                        <div className='space-y-8'>
                            <div className='space-y-4'>
                                <Badge className='bg-blue-100 px-4 py-2 text-blue-700'>
            ...
            <section className='bg-gray-50 px-4 py-16'>
                <div className='mx-auto max-w-7xl'>
                    <div className='grid items-center gap-12 lg:grid-cols-2'>
                        ...
                        <div className='space-y-8'>
                            <div className='space-y-4'>
                                <Badge className='bg-purple-100 px-4 py-2 text-purple-700'>
                                ...
                                <div className='space-y-4'>
                                    {['step1', 'step2', 'step3', 'step4'].map((stepKey) => (
                                        <div key={stepKey} className='flex gap-4'>
                                            <div className='flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-purple-600 text-sm font-semibold text-white'>
