                ...
                <div className='container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                    <div className='flex min-h-[400px] flex-col items-center justify-center'>
                        <div className='max-w-md rounded-2xl bg-white p-8 text-center shadow-xl'>
                            ...
                            <h1 className='mb-2 text-2xl font-bold text-gray-900'>Device Data Unavailable</h1>
                            ...
                            <TabsList className='grid h-16 w-full max-w-4xl grid-cols-2 rounded-2xl border border-gray-200 bg-white p-2 shadow-lg lg:grid-cols-3'>
                                {allCategories.map((category) => (
                                    <TabsTrigger
                                        key={category.id}
                                        value={category.id}
                                        className='flex items-center gap-2 rounded-xl px-3 py-2 font-semibold transition-all duration-300 data-[state=active]:bg-black data-[state=active]:text-white data-[state=active]:shadow-md'>
                                        {category.icon}
                                ...
                                <div>
                                    ...
                                    <div className='mb-8 text-center'>
                                        <div className='mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-100'>
                                            <div className='text-2xl text-blue-600'>{filteredData.icon}</div>
                                        </div>
                    ...
                    <div className='rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white'>
                        ...
                        <div className='flex flex-col justify-center gap-4 sm:flex-row'>
                            <Link
                                ...
                                className='inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-blue-600 hover:bg-blue-50'>
