                    ...
                    <div className='flex flex-col items-center gap-8 lg:flex-row lg:gap-12'>
                        ...
                        <div className='flex-1 text-center lg:pt-24 lg:text-left'>
                            ...
                            <div className='mb-8 space-y-2'>
                                <h1 className='bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-4xl leading-[0.9] font-black tracking-tight text-transparent drop-shadow-sm sm:text-5xl md:text-6xl lg:text-7xl'>
                                    {t('home.hero.mainHeading')}
                                </h1>

                                <h2 className='bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-2xl leading-tight font-semibold tracking-tight text-transparent opacity-90 drop-shadow-sm sm:text-3xl md:text-4xl lg:text-5xl'>
                                ...
                                <div
                                    ...
                                    <div className='h-64 overflow-hidden rounded-lg shadow-lg sm:row-span-2 sm:h-auto sm:rounded-xl'>
                                        <Image
                                            ...
                                            alt='esimtel Voice - Global calling service'
                                            width={400}
                                            height={400}
