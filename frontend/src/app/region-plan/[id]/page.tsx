                    ...
                    {regionInfo && (
                        <div className='mb-6 flex items-center justify-center gap-4'>
                            ...
                            <div className='text-left'>
                                <h1 className='text-3xl font-bold text-gray-900 md:text-4xl'>{regionInfo.name}</h1>
                            ...
                            <div
                                ...
                                <div className='mb-4 flex items-center gap-3'>
                                    <div className='relative h-8 w-8 overflow-hidden rounded-full border border-gray-200'>
                                        <Image
                                            src={plan.region.image}
                                            alt={`${plan.region.name} region`}
                                            width={32}
                                            height={32}
                                            className='h-full w-full object-cover'
                                            unoptimized
                                    ...
                                    <div>
                                        <h3 className='text-sm font-bold text-gray-900'>{plan.region.name}</h3>
